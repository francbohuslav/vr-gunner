              ...
              <a-entity rotation="0 0 -5">
                <a-entity id="right-gun-position" rotation="0 -6 0">
                  ...
                  <a-entity position="0 -0.054 0.05">
                    <a-entity id="right-gun" rotation="0 -90 0" gltf-model="#gun-model" material="src: #gun-texture" scale="${gunScale} ${gunScale} ${gunScale}">
            ...
            <a-entity rotation="-52 0 0">
              <a-entity rotation="0 0 -5">
                <a-entity id="left-gun-position" rotation="0 6 0">
                  <a-entity position="0 -0.054 0.05">
                    <a-entity id="left-gun" rotation="0 -90 0" gltf-model="#gun-model" material="src: #gun-texture" scale="${gunScale} ${gunScale} ${gunScale}">
                      <a-entity scale="100 100 100" position="2.7 3.5 0" rotation="-5.883 90 0" lives></a-entity>
                    </a-entity>
                  </a-entity>
                </a-entity>
